...
$key2=$row->password;
 ...
 if($key2 == $pass && $key1 == $user)
    ...
    echo "<script type='text/javascript'>alert('Login Successfull')</script>";  
     echo "<script>setTimeout(\"location.href='home.html';\",11);</script>";
    } 

  else
   {
echo "<script type='text/javascript'>alert('Invalid Username/Password')</script>";
echo "<script>setTimeout(\"location.href='home.php';\",11);</script>";
   }
}
?>
...
<tr>
<td>
<label>Password:</label></td><td><input type="password" name="password" placeholder="Enter Password" size=50 required/></td>
</tr>
<tr>
